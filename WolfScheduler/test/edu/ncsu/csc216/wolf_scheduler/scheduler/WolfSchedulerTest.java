...
public class WolfSchedulerTest {
	 ...
	 * @throws ConflictException Exception thrown if conflict
	 */
	@Test
	 ...
	 */
	@Test
	public void testAddEventToSchedule() throws ConflictException {
		WolfScheduler ws = new WolfScheduler(validTestFile);
	 ...
	 */
	@Test
	public void testRemoveActivityFromSchedule() throws ConflictException {
		WolfScheduler ws = new WolfScheduler(validTestFile);
	 ...
	 */
	@Test
	public void testGetScheduledActivities() throws ConflictException {
		WolfScheduler ws = new WolfScheduler(validTestFile);
	 ...
	 */
	@Test
	public void testGetFullScheduledActivities() throws ConflictException {
		WolfScheduler ws = new WolfScheduler(validTestFile);
	 ...
	 */
	@Test
	public void testExportSchedule() throws ConflictException {
	...
	/**
	 * Tests the confliciting activities
	 * @throws ConflictException Exception thrown if conflict
	 */
	@Test
	public void testConflictingActivity() throws ConflictException {
		WolfScheduler ws = new WolfScheduler(validTestFile);
		ws.addCourseToSchedule("CSC 316", "001");
		try {
		...
		WolfScheduler ws2 = new WolfScheduler(validTestFile);
		ws2.addCourseToSchedule("CSC 316", "001");

		Exception e2 = assertThrows(IllegalArgumentException.class,
				() -> ws2.addEventToSchedule("ASD", "M", 900, 930, "Hello"));
